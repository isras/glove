...
urlpatterns = [
    ...
    url('^cab_rides/(?P<username>.+)/$', views.CustomerCabRideHistoryList.as_view()),
    ...
    url('^coupons/(?P<username>.+)/$', views.CustomerCouponsHistoryList.as_view()),
    url(r'^delivery/$', views.DeliveryList.as_view()),
    url(r'^delivery/(?P<pk>[0-9]+)/$', views.DeliveryDetail.as_view()),
    url('^delivery/(?P<username>.+)/$', views.CustomerDeliveryHistoryList.as_view()),
    url(r'^book_taxi/$', views.BookTaxiList.as_view()),
    url(r'^book_taxi/(?P<pk>[0-9]+)/$', views.BookTaxiDetail.as_view()),
    url('^book_taxi/(?P<username>.+)/$', views.CustomerBookTaxiHistoryList.as_view()),
